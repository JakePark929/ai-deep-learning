...
MAPPING = {
    '인사동': './resources/ninetree_insa_reviews.json',
    '판교': './resources/ninetree_pangyo_reviews.json',
    '용산': './resources/ninetree_youngsan_reviews.json'
}
with open('./resources/prompt_1shot.pickle', 'rb') as f:
